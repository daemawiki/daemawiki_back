...
public class UserController {
    ...
    @GetMapping("/find")
    public Flux<GetUserResponse> getUser(@RequestParam Integer gen, @RequestParam String major, @RequestParam String club) {
        return getUser.getUserByGenAndMajorAndClub(gen, major, club);
    }
