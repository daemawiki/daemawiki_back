...
public class ProfileImageUpload {
    ...
    public ProfileImageUpload(UserFacade userFacade, S3Service s3Service, UserRepository userRepository) {
    ...
    public Mono<Void> execute(FilePart filePart) {
        return userFacade.currentUser()
                .zipWith(s3Service.uploadObject(filePart, "profile"), (user, file) -> {
